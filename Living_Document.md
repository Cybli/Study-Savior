...
### **Nat**
Similar to my peers, I found that developing in a group with a layered architecture pattern was tough overall. Communication was the biggest concern for the entire term, and I believe that we did handle it relatively well. I believe that I learned that setting up times to meet, outside of classes, was incredibly critical to making progress, as it ensured that the necessary things got done in the moment. As group coordinator, my failure to do so in the latter weeks of the term meant that we, including myself, fell behind where we would have liked to have been at the time, but we managed to pull through in the end and all do our parts. The way I worked with this was sending when2meet links in the group chat, which is a platform that allows users to submit the times that they're available, as we are college students and schedules can be inconsistent.

An extra thing about planning that hit me especially strongly during this was that, people are going to get sick, or have events come up in their lives, and as a group manager, you need to be prepared to assign someone else to cover, or cover yourself. I personally was also sick and had a lot going on during the term, and my procrastination was a failure on my part, meaning that I didn't have things prepared ahead of deadlines, and suffered as such.

Another important thing I learned is that it can be hard to gather realistic data to test your program. To remedy this, we discovered that, as members of the intended userbase of our app, we could submit reviews for locations for our project, and I went out and took many of the photos currently seen on our website right now. If we were not members of the target audience, I believe that finding connections we have to people who would be, and then having them imitate use of the app would be an ideal strategy.

Overall, I believe that I’ve learned a lot about how software production functions in the real world, and that it is far different to be developing as a member of a team, than a solo developer writing code for a class assignment. Understanding how to gather requirements, select system architectures, design mockups, and iterate along the way is vastly important when it comes to real world applications.
